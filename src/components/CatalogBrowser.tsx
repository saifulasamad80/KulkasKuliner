  ...
  return (
    <div className="w-full">
      <div className="mb-10 rounded-[26px] border border-black/6 bg-white p-3 shadow-[0_12px_35px_rgba(91,44,16,0.06)] sm:p-4">
        <div className="relative"><label htmlFor="catalog-search" className="sr-only">Cari produk</label><input id="catalog-search" type="text" placeholder="Cari frozen food, lauk, atau cemilan..." aria-label="Cari produk" className="h-12 w-full rounded-2xl border border-[#eee5df] bg-[#fffaf7] pl-11 pr-4 text-sm font-semibold text-[#171717] outline-none transition focus:border-[#dc2626] focus:ring-4 focus:ring-red-100" value={searchQuery} onChange={(event) => setSearchQuery(event.target.value)} /><span className="absolute left-4 top-3 text-xl text-[#a99c93]">⌕</span></div>
